...
/**
 * Set authorization form username and password
 *
 ...
 * @return {XmlRpc}
 */
XmlRpc.prototype.setAuthorizationByUsernameAndPassword = function call(username, password) {
    this.authorization = btoa(username + ':' + password)
    return this
}

/**
 * Set authorization form token (username and password base 64 encoded)
 *
 * @param {String} token
 * 
 * @return {XmlRpc}
 */
XmlRpc.prototype.setAuthorizationByToken = function call(token) {
...
XmlRpc.prototype.call = function call(method, params, callback) {
    ...
    axios.post(this.uri, 
      ...
      headers
        ...
        let r = this._decodeResponse(response)
...
/**
 * Decode an XML-RPC call
 *
 * @param {String} response
 * 
 * @return {Mixed|null}
 */
XmlRpc.prototype._decodeResponse = function _decodeResponse(response){
    return this.parser.decode(response.data)    
}
